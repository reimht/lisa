<?php
	...
	**/
	...
	$_SESSION["step"]=0;
	$_SESSION["temp_image_file_path"]=$settings["temp_image_file_path"].session_id();
	$_SESSION["image_type"]="";
	//Schülerdaten
	$_SESSION["given_name"]="";
	...
	if( in_array( $_SESSION["REMOTE_ADDR"] , $_SESSION["settings"]["ip_notan"] ) OR $_SESSION["settings"]["tan_active"]=="no" ){
        ...
        echo create_header("BBS2Leer", "","",$meta,$body);
